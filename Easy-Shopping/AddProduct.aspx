<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Easy_Shopping.AddProduct" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtMatCare" TextMode="MultiLine" CssClass="form-control" runat="server" OnTextChanged="txtMatCare_TextChanged"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:CheckBox ID="cbFD" runat="server" OnCheckedChanged="cbFD_CheckedChanged" />
                </div>
            </div>
            <div class="form-group">
                <asp:Label ID="Label17" runat="server" CssClass="col-md-2 control-label" Text="30 Days Return"></asp:Label>
                <div class="col-md-3">
                    <asp:CheckBox ID="cb30Ret" runat="server" OnCheckedChanged="cb30Ret_CheckedChanged" />
                </div>
            </div>
            <div class="form-group">
