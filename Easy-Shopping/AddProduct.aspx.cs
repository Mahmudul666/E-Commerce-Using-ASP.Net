    ...
    public partial class AddProduct : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                DataSet ds = new DataSet("tblProducts");
                dt.Fill(ds, "Products");
                ds.WriteXml(Server.MapPath(@".\xml\tblProducts.xml"));

                //string strSQL1 = "SELECT * FROM tblProductImages";
                //SqlDataAdapter dt1 = new SqlDataAdapter(strSQL1, con);
                //DataSet ds1 = new DataSet("tblProductImages");
                //dt.Fill(ds, "tblProductImages");
                //ds.WriteXml(Server.MapPath(@".\xml\tblProductImages.xml"));
        ...
        protected void cb30Ret_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected void cbFD_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected void txtMatCare_TextChanged(object sender, EventArgs e)
        {
